...
- **DistiLRR: Transferring Code Repair for Low-Resource Programming Languages**  
  ...
  *Findings of the North American Chapter of the Association for Computational Linguistics, 2025 (NAACL 2025)*  
  [(Paper)](https://arxiv.org/abs/2406.14867)
...
- **Generalization vs Memorization: Tracing Language Models' Capabilities Back to Pretraining Data**  
  ...
  *International Conference on Learning Representations 2025 (ICLR 2025)*  
  [(Paper)](https://arxiv.org/abs/2407.14985)
...
- **Understanding the Reasoning Ability of Language Models From the Perspective of Reasoning Paths Aggregation**  
  ...
  *Proceedings of the 41st International Conference on Machine Learning (ICML 2024)*  
  [(Paper)](https://arxiv.org/abs/2402.03268)
...
- **Neural Methods for Logical Reasoning over Knowledge Graphs**  
  ...
  *International Conference on Learning Representations 2022 (ICLR 2022)*  
  [(Paper)](https://arxiv.org/pdf/2209.14464.pdf) [(Slides)](https://iclr.cc/media/iclr-2022/Slides/5976.pdf) [(Code)](https://github.com/amayuelas/NNKGReasoning)

## 2021

- **The importance of modeling data missingness in algorithmic fairness: A causal perspective**  
  Naman Goel, **Alfonso Amayuelas**, Amit Deshpande, Amit Sharma  
  *Proceedings of the AAAI Conference on Artificial Intelligence, 35(9), 7564-7573, 2021 (AAAI 2021)*  
  [(Paper)](https://arxiv.org/pdf/2012.11448.pdf)
